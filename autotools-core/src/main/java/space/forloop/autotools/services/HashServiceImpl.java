...
public class HashServiceImpl implements HashService {
  ...
  public long getPerceptualHash(final File imageFile) {
    try {
      ...
      log.info("Error generating perceptual hash: {}", e.getMessage(), e);
    }
  ...
  private void drawImage(final Image image, final BufferedImage scaledImage) {
