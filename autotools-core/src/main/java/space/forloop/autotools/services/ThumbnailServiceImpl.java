...
public class ThumbnailServiceImpl implements ThumbnailService {
  ...
  public Path create(final FileWrapper fileWrapper) {
    try {
      final java.io.File videoFile = new java.io.File(fileWrapper.getPath());
      ...
      final java.io.File tempFile = java.io.File.createTempFile(fileWrapper.getName() + "-", ".jpg");
